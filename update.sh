...
export GOPATH=/opt/go && export GOBIN=$GOPATH/bin && export PATH=$PATH:/usr/local/go/bin:$GOBIN && cd /opt/TA-AKTVEAPIServer && go build -o /opt/TA-AKTVEAPIServer/ta-aktveapiserver && cd -
